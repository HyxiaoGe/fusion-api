...
class ErrorCode(str, Enum):
    ...
    KNOWLEDGE_CONFIG_INVALID = "KNOWLEDGE_CONFIG_INVALID"
    KNOWLEDGE_BASE_NOT_READY = "KNOWLEDGE_BASE_NOT_READY"
    KNOWLEDGE_DOCUMENT_NOT_READY = "KNOWLEDGE_DOCUMENT_NOT_READY"
    KNOWLEDGE_DOCUMENT_DUPLICATE = "KNOWLEDGE_DOCUMENT_DUPLICATE"
    KNOWLEDGE_DOCUMENT_NOT_RETRYABLE = "KNOWLEDGE_DOCUMENT_NOT_RETRYABLE"
    KNOWLEDGE_DOCUMENT_UNSUPPORTED = "KNOWLEDGE_DOCUMENT_UNSUPPORTED"
    KNOWLEDGE_DOCUMENT_TYPE_MISMATCH = "KNOWLEDGE_DOCUMENT_TYPE_MISMATCH"
    KNOWLEDGE_SCANNED_DOCUMENT_UNSUPPORTED = "KNOWLEDGE_SCANNED_DOCUMENT_UNSUPPORTED"
    KNOWLEDGE_STORAGE_BUSY = "KNOWLEDGE_STORAGE_BUSY"
    KNOWLEDGE_STORAGE_UNAVAILABLE = "KNOWLEDGE_STORAGE_UNAVAILABLE"
    KNOWLEDGE_EMBEDDING_UNAVAILABLE = "KNOWLEDGE_EMBEDDING_UNAVAILABLE"
    KNOWLEDGE_EMBEDDING_DIMENSION_MISMATCH = "KNOWLEDGE_EMBEDDING_DIMENSION_MISMATCH"
    KNOWLEDGE_VECTOR_UNAVAILABLE = "KNOWLEDGE_VECTOR_UNAVAILABLE"
    KNOWLEDGE_VECTOR_RESPONSE_INVALID = "KNOWLEDGE_VECTOR_RESPONSE_INVALID"
